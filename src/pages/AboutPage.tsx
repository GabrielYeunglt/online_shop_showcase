...
const AboutPage = () => {
    ...
    const getCertRows = (certs: Certification[]) => {
        return (
            <tbody>
                {certs.map((cert) => (
                    <tr>
    ...
    const getSenecaSkills = (skills: Skill[]) => {
        let key = 0;
        return (
            <ol>
                {skills.map((skill) => {
    ...
    return (
        <div>
            <div className="p-4 p-md-5 mb-4 rounded text-body-emphasis bg-body-secondary row">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 px-0 order-lg-1 order-md-2 order-sm-2">
            ...
            <div className="container">
                <article className="blog-post">
                    ...
                    <p className="blog-post-meta">October 2012 - June 2015</p>
                ...
                <article className="blog-post">
                    <h2 className="display-5 link-body-emphasis mb-1">Flexystem Limited</h2>
                    <h3>Programmer</h3>
                    <p className="blog-post-meta">October 2015 - April 2019, Hong Kong</p>
                    <div className="container">
                        <img
                ...
                <article className="blog-post">
                    ...
                    <p className="blog-post-meta">August 2019 - March 2023, Hong Kong</p>
                ...
                <article className="blog-post">
                    <h2 className="display-5 link-body-emphasis mb-1">Seneca College</h2>
                    <h3>Diploma in Computer Programming</h3>
                    <p className="blog-post-meta">May 2023 - August 2024, Toronto</p>
